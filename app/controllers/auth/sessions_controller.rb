  ...
  #         end
  #       else
  #         # Proceed with standard DeviseTokenAuth login
  #         super
  #       end
  #     else
  ...
  #       # OTP is valid, handle successful login
  #       sign_in(user, store: false) # Store: false means we don't want to store the session
  ...
  #     Rails.logger.error "Error sending OTP email to #{user.email}: #{e.message}"
  #     false
  #   end
  ...
  #         Rails.logger.info "Assigned admin role to user ID: #{user.id}"
  #       else
